...
export const en = {
  ...
  'game.directionCw': 'Play order: normal',
  'game.directionCcw': 'Play order: reversed',
  'game.playOrderNext': 'After you: {name}',
  'game.playOrderReversed': 'reversed',
  ...
  'event.runCancelled.one': '{name} played a King and cancelled the 1 card owed.',
  'event.runCancelled.other': '{name} played a King and cancelled the {count} cards owed.',
  'event.plusDeniedWin':
    'A Plus owes another card, so {name} did not finish — one card drawn, and the declaration goes again.',
  ...
  'event.directionChangedCw': 'The play order is back to normal.',
  'event.directionChangedCcw': 'The play order is reversed.',
  ...
  'plusHeld.you':
    'A Plus cannot be your last card — it owes another one, so you drew from the pile. Declare "last card" again.',
  'plusHeld.other': 'A Plus cannot be a last card — {name} drew from the pile, and the round goes on.',
  'nudge.send': 'Nudge',
